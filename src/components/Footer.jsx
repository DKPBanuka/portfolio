...
const Footer = () => {
  return (
    <footer className="w-full bg-white/80 dark:bg-gray-800/80 backdrop-blur-2xl shadow-[0_8px_30px_-18px_rgba(0,0,0,.10)] ring-1 ring-pink-50 dark:ring-pink-900 border-t border-pink-50/40 dark:border-pink-900/40 text-gray-900 dark:text-gray-100 py-6 mt-10 transition-colors duration-300">
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <span className="font-bold text-lg tracking-wide">© {new Date().getFullYear()}  Pasindu Banuka</span>
          <span className="text-xs bg-pink-50/40 dark:bg-pink-900/40 rounded px-2 py-1 ml-2"> DevOps Engineer | Full Stack Developer</span>
        </div>
        <div className="flex gap-4 mt-2 md:mt-0">
          <a href="https://github.com/DKPBanuka" target="_blank" rel="noopener" className="hover:text-gray-500 dark:hover:text-gray-400 transition">
          ...
          <a href="https://wa.me/94789287469" target="_blank" rel="noopener" className="hover:text-green-500 dark:hover:text-green-400 transition">
